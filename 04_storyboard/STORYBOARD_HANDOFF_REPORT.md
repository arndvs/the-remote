...
**Image:** Medium shot facing closet entrance. Dave tumbles out — dress shirt half-tucked, ONE shoe, no tie. The vertical bed waits beside the entrance. Sheet nearly taut, pillow fuller but slightly off-center (self-making nearly done).
...
**Image:** Two-panel beat. (A) Close-up: the pillow at the top of the vertical bed. Pneumatic node completes its cycle — a slow, soft exhale. Pillow settles, centers, stills. (B) Cut to: Dave's hands fighting the tie knot while being rolled forward. Wrong. Still wrong. Slightly less wrong.
**Shot Type:** CU pillow → CU Dave's hands and tie
**Action:** The self-making sequence completes. Pillow perfect. Dave's knot is garbage.
**Dialogue:** DAVE _(looking down at tie):_ "Good enough."
**Camera:** The cut between the perfect pillow and the terrible tie says everything. Do not add to it.
